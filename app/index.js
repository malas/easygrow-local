...
agenda.on('ready', function() {
  ...
  agenda.every('0-4,10-14,20-24,30-34,40-44,50-54 * * * *', 'relay switch', { pins: relayPins, status: true });
  agenda.every('5-9,15-19,25-29,35-39,45-49,55-59 * * * *', 'relay switch', { pins: relayPins, status: false });
